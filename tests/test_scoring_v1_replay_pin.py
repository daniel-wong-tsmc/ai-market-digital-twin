...
PINNED = {
    ...
    "2026-07-v9.json": W_CURRENT,   # 2026-07-16 daily cycle; post-F60 -> CURRENT
    "2026-07-v10.json": W_CURRENT,  # 2026-07-17 daily cycle; post-F60 -> CURRENT
    "2026-07-v11.json": W_CURRENT,  # 2026-07-18 daily cycle; post-F60 -> CURRENT
    "2026-07-v12.json": W_CURRENT,  # 2026-07-20 live merchant-gpu cycle; post-F60 -> CURRENT
    "2026-07-v13.json": W_CURRENT,  # 2026-07-20 live merchant-gpu cycle (concurrent run, finalized 2026-07-21); post-F60 -> CURRENT; replays exactly
    "2026-07-v14.json": W_CURRENT,  # 2026-07-22 daily cycle; post-F60 -> CURRENT
    "2026-07-v15.json": W_CURRENT,  # 2026-07-23 daily cycle; post-F60 -> CURRENT
    "2026-07-v16.json": W_CURRENT,  # 2026-07-24 daily cycle; post-F60 -> CURRENT
    "2026-07-v17.json": W_CURRENT,  # 2026-07-25 daily cycle; post-F60 -> CURRENT
    "2026-07-v18.json": W_CURRENT,  # 2026-07-26 daily cycle; post-F60 -> CURRENT
    "2026-07-v19.json": W_CURRENT,  # 2026-07-27 daily cycle; post-F60 -> CURRENT
    "2026-07-v20.json": W_CURRENT,  # 2026-07-28 daily cycle; post-F60 -> CURRENT
    "2026-07-v21.json": W_CURRENT,  # 2026-07-29 daily cycle; post-F60 -> CURRENT
    "2026-08-v1.json": W_CURRENT,   # 2026-08-04 daily cycle, first of the month; post-F60 -> CURRENT
    "2026-08-v2.json": W_CURRENT,   # 2026-08-05 daily cycle; post-F60 -> CURRENT
    ...
    "2026-08-v7.json": W_CURRENT,   # 2026-08-11 daily cycle; post-F60 -> CURRENT
    "2026-08-v8.json": W_CURRENT,   # 2026-08-19 daily cycle; post-F60 -> CURRENT
    "2026-08-v9.json": W_CURRENT,   # 2026-08-21 daily cycle; post-F60 -> CURRENT
    "2026-08-v10.json": W_CURRENT,  # 2026-08-22 daily cycle; post-F60 -> CURRENT
    "2026-08-v11.json": W_CURRENT,  # 2026-08-23 daily cycle; post-F60 -> CURRENT
    "2026-08-v12.json": W_CURRENT,  # 2026-08-24 daily cycle; post-F60 -> CURRENT
    "2026-08-v13.json": W_CURRENT,  # 2026-08-25 daily cycle (scheduled headless); post-F60 -> CURRENT
    "2026-08-v14.json": W_CURRENT,  # 2026-08-26 daily cycle (scheduled headless); post-F60 -> CURRENT
    "2026-08-v15.json": W_CURRENT,  # 2026-08-27 daily cycle (scheduled headless; first with NVIDIA Q2 FY2027); post-F60 -> CURRENT
    "2026-08-v16.json": W_CURRENT,  # 2026-08-30 daily cycle (scheduled headless); post-F60 -> CURRENT
    "2026-08-v17.json": W_CURRENT,  # 2026-08-31 daily cycle (scheduled headless); post-F60 -> CURRENT
    ...
    "2026-09-v5.json": W_CURRENT,   # 2026-09-06 daily cycle (scheduled headless, 18:04 local fire resuming the dead 16:02 instance's gather; rescue-committed v4 first); post-F60 -> CURRENT
    "2026-09-v6.json": W_CURRENT,   # 2026-09-07 daily cycle (scheduled headless, 20:22 local fire; single instance, clean tree); post-F60 -> CURRENT
    ...
    "2026-09-v11.json": W_CURRENT,  # 2026-09-16 daily cycle (scheduled headless, 07:28 local fire; rescued v10 first, reused the dead 07:07 instance's gather); post-F60 -> CURRENT
    "2026-09-v12.json": W_CURRENT,  # 2026-09-17 daily cycle (scheduled headless, 19:41 local fire; single instance, clean tree); post-F60 -> CURRENT
}
