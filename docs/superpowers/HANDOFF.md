...
- **Date: 2026-07-16/17 — F97 EXECUTIVE-BRIEF RENDERER BUILT (subagent-driven), pushed on branch, NOT merged.**
  ...
  review "ready to merge: yes". **No open pre-merge blockers.** Records: `docs/fix-backlog.md` F97 +
  `.superpowers/handoffs/f97-exec-brief-DONE.md`. **Branch pushed; only the user merges.**
...
- **F97 lane DONE ON BRANCH — PUSHED, AWAITING USER MERGE (built 2026-07-16/17, subagent-driven; only the user merges).**
  ...
  **Whole-branch review Important #1 — FIXED (user-approved interactive 2026-07-17, commit `e866c3d`).** The brief's
  ...
  "ready to merge: yes". **No open pre-merge blockers — awaiting only the user's merge.** Records:
